...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            sensor_gains = [0.1 0.1 0.2 0.1 0.1];
            u_i = ir_distances_wf - [x ; y];
            u_ao = sum(u_i .* sensor_gains, 2);
            
            % Compute the heading and error for the PID controller
            theta_ao = atan2(u_ao(2), u_ao(1)); % angle of heading vector
            e_k = theta_ao - theta; % diff between steer angle and angle of robot
...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
        ...
        function ir_distances_wf = apply_sensor_geometry(obj, ir_distances, state_estimate)
            ...
            for i=1:n_sensors
                ...
                v_i = [ir_distances(i); 0];
                ir_distances_rf(:,i) = R * [v_i; 1];
            end
